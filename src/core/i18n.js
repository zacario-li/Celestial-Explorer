...
export const i18n = {
    en: {
        ...
        plannedPathOn: '🛰️ PLAN PATH: ON',
        boostOn: '⚡ BOOST: ON (speed)',
        boostOff: '⚡ BOOST: OFF (best image)',
        plannedPathOff: '🛰️ PLAN PATH: OFF',
    ...
    zh: {
        ...
        ignitionTitle: '恒星点火！',
        miscSettings: '🛠️ 杂项设置',
        plannedPathOn: '🛰️ 规划轨迹线：开',
        boostOn: '⚡ 极速模式：开',
        boostOff: '⚡ 极速模式：关（画质最佳）',
        plannedPathOff: '🛰️ 规划轨迹线：关',
        futurePathOn: '🔴 预测轨迹：开',
