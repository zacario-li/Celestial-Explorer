...
export const i18n = {
    ...
    zh: {
        ...
        hoverZonesOn: '👾 悬停区域：开',
        hoverZonesOff: '👾 悬停区域：关',
        pilotStart: '🚀 驾驶飞船',
        pilotEnd: '❌ 退出驾驶',
        pilotInstructions: 'W/S: 油门 • 方向键: 俯仰/偏航 • Q/E: 滚转',
        pilotAutoLevel: '⚖️ 自动改平',
        spawnPlanet: '➕ 生成新行星',
        ...
        stationKeepingActive: '位置保持：已激活',
        stationKeepingHint: '按 W 键解除锁定',
        targetThrottle: '目标油门'
    }
};
